...
function calcPrice({ pages=1, academicLevel='licenciatura', style='argumentacao', methodology='qualitativa', urgencyDays=7, extras=0 }) {
  const base = levelBase[academicLevel] || levelBase['licenciatura'];
  ...
  let urgencyPct = 0;
  if (urgencyDays <= 2) urgencyPct = 1.00;
